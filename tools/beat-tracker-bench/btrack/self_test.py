...
BTrack's comb-filter/autocorrelation tempo estimation was originally tuned
against real music, not pure synthetic clicks, so this is a wiring/sanity
check, not a claim about BTrack's accuracy on real audio.
