...
The two major roadmap items originally drafted here have been moved to the main
planning documents:

- **scenes-01 (Scene Recorder & Playback)** — see P3-MIDI section in
  `docs/planning/prioritized-action-plan-2026-06-03.md`
- **Live Effect Builder Mode (v2.0)** — see DW-004 in
