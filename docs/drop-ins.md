...
| effects-games | Yes | Not required | Effect pack: Breakout, Neon Pac, Galaga, Joust, Tetris, Missile Command, Donkey Kong, Q*bert, Super Mario, Mario Kart, Frogger, Marble Madness |
...
| effects-ukiyo-e | Yes | Not required | Effect pack: Floating World, Onden Watermill, Raijin's Drums, Night Parade (neon/steampunk ukiyo-e) |
...
- dj-mixer-01
  ...
  - [Offline Analysis Accuracy — plan (bpm/key/structure/grid anchor)](../drop-ins/dj-mixer-01/docs/offline-analysis-accuracy-plan.md)
