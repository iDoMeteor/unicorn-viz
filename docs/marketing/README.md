...
- [Week 2 Asset and Post Rollout (D-23 to D-17)](week-2-asset-post-rollout.md)
- [Week 2 Expanded Pack v1 (Prompts and Pre-Crafted Copy)](week-2-expanded-pack-v1.md)
- [Week 3 Asset and Post Rollout (D-16 to D-10)](week-3-asset-post-rollout.md)
- [Week 3 Expanded Pack v1 (Prompts and Pre-Crafted Copy)](week-3-expanded-pack-v1.md)
- [Week 4 Asset and Post Rollout (D-09 to D-03)](week-4-asset-post-rollout.md)
- [Week 4 Expanded Pack v1 (Prompts and Pre-Crafted Copy)](week-4-expanded-pack-v1.md)
- [Week 5 Asset and Post Rollout (D-02 to D-01)](week-5-asset-post-rollout.md)
...
- [Creator Launch Pack (PDF)](creator-private-launch.pdf)
- [Public Launch Pack (HTML)](public-launch.html)
- [Public Launch Pack (PDF)](public-launch.pdf)

## Notes

- The launch strategy is the current operating source of truth for the 30-day pre-premiere campaign, the 6-day livestream block, and the 60-day post-premiere follow-through.
- The one-sheet and launch packs are outward-facing assets for creators, partners, and press.
- The June calendar is a scheduling aid and should be refreshed once final dates, platform priorities, and stream times are locked.
