...
def test_legacy_prior_push_behind_the_rollback_flag(monkeypatch) -> None:
    ...
    2026-09-11 (recommender rc.48, owner-approved fitted weights):
    `zcr_fit`'s weight came out of the ceiling-test fit at `-0.111`, a
    sign flip from the positive value every crossover above was swept
    against -- flips who wins at 0.04 specifically (re-swept 0.0-0.15:
    `drum_and_bass` now wins a stable 0.02-0.06 band, `rap_rnb` wins
